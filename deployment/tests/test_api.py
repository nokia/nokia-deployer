...
class TestApi(unittest.TestCase):
    ...
    def _load_fixtures(self, session):
        ...
        entities = [
            ...
            m.Environment(id=1, repository_name="another repo", name="dev", remote_user="deploy", target_path="/path"),
            m.Environment(id=2, repository_name="my repo", name="dev", deploy_branch="master", env_order=1, clusters=[clusters[0]], target_path="/path"),
            m.Environment(id=3, repository_name="my repo", name="beta", deploy_branch="prod", env_order=2, target_path="/path"),
            m.Environment(id=4, repository_name="my repo", name="prod", deploy_branch="prod", env_order=3, target_path="/path"),
